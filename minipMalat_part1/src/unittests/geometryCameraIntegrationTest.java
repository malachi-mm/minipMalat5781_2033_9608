...
public class geometryCameraIntegrationTest {
     ...
     */
    public int countIntersectionNumbers(Intersectable body,Camera camera){
        int sum=0;
    ...
    public void testIntersectionSphere() {
       ...
       Sphere sphere=new Sphere(new Point3D(0,0,-3),1d);
        assertEquals(countIntersectionNumbers(sphere,camera),2
        ...
        assertEquals(countIntersectionNumbers(sphere,camera2),18
                ,"the number of intersection isn't right");
    ...
    public void testIntersectionTriangle() {
        ...
        assertEquals(countIntersectionNumbers(triangle,camera2),1
                ,"the number of intersection isn't right");
        ...
        assertEquals(countIntersectionNumbers(triangle,camera2),2
                ,"the number of intersection isn't right");
    ...
    public void testIntersectionPlane() {
       ...
       // Camera camera2 = new Camera(new Point3D(0,0,0.5d), new Vector(0, 0, -1), new Vector(0, 1, 0)).setDistance(1);
        ...
        assertEquals(countIntersectionNumbers(plane,camera),9
                ,"the number of intersection isn't right");
        ...
        assertEquals(countIntersectionNumbers(plane,camera),5
                ,"the number of intersection isn't right");
        ...
        assertEquals(countIntersectionNumbers(plane,camera),0
                ,"the number of intersection isn't right");
