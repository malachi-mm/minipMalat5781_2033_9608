...
public class ShadowTests {
	...
	public void sphereTriangleInitial() {
		...
		Render render = new Render(). //
				setWriter(new ImageWriter("shadowSphereTriangleInitial", 400, 400)) //
				.setCamera(camera) //
	...
	public void sphereTriangleLightMove1() {
		...
		Render render = new Render(). //
				setWriter(new ImageWriter("shadowSphereTriangleLightMove1", 400, 400)) //
				.setCamera(camera) //
				.setRayTracer(new RayTracerBasic(scene));
		render.renderImage();
		render.writeToImage();
	...
	public void sphereTriangleLightMove2() {
		...
		Render render = new Render(). //
				setWriter(new ImageWriter("shadowSphereTriangleLightMove2", 400, 400)) //
				.setCamera(camera) //
				.setRayTracer(new RayTracerBasic(scene));
		render.renderImage();
		render.writeToImage();
	...
	@Test
	public void sphereTriangleHigh1() {
		scene.geometries.add( //
				new Sphere( new Point3D(0, 0, -200),60) //
						.setEmission(new Color(java.awt.Color.BLUE)) //
						.setMaterial(new Material().setkD(0.5).setkS(0.5).setnShininess(30)), //
		...
		Render render = new Render(). //
				setWriter(new ImageWriter("shadowSphereTriangleHigh1", 400, 400)) //
				.setCamera(camera) //
				.setRayTracer(new RayTracerBasic(scene));
		render.renderImage();
		render.writeToImage();
	...
	@Test
	public void sphereTriangleHigh2() {
		scene.geometries.add( //
				new Sphere( new Point3D(0, 0, -200),60) //
						.setEmission(new Color(java.awt.Color.BLUE)) //
						.setMaterial(new Material().setkD(0.5).setkS(0.5).setnShininess(30)), //
		...
		Render render = new Render(). //
				setWriter(new ImageWriter("shadowSphereTriangleHigh2", 400, 400)) //
				.setCamera(camera) //
				.setRayTracer(new RayTracerBasic(scene));
		render.renderImage();
		render.writeToImage();
	 ...
	 */
	@Test
	public void trianglesSphereLightMove1() {
		...
		Render render = new Render() //
				.setWriter(new ImageWriter("shadowTrianglesSphere", 600, 600)) //
				.setCamera(camera) //
				.setRayTracer(new RayTracerBasic(scene));
		render.renderImage();
		render.writeToImage();
